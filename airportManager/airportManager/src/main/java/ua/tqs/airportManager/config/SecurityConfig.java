        ...
        return http
            ...
            .authorizeHttpRequests(authRequest ->
                authRequest
                    ...
                    .requestMatchers("/api/flights/{flightId}/{state}").permitAll()
                    ...
                    .requestMatchers("/api/passengers/{id}/check-in").permitAll()
                    ...
                    .requestMatchers("/api/luggage/luggage").permitAll()
                    .requestMatchers("/api/luggage/luggage/{id}").permitAll()
                    .requestMatchers("/api/luggage/createLuggage").permitAll()
